...
public enum Letters
{
	Competition, //Конкурс
	Update, //Обновление
	CompletLoveTest, //Пройден тест на любовь -
	CompletFriendshipTest,  //Пройден тест на дружбу -
	CompletValuesTest, //Пройден тест на ценности -
	CompletMutuallyTest, //Пройден тест на взаимность - 
	CompletConfidenceTest, //Пройден тест на доверие -
	CompletTestOfNamesMode, //Пройден режим взаимности имен -
	CompletScanerMode, //Пройден режим сканирования -
	CompletTreeMode, //Пройден режим воспоминание о лете -
